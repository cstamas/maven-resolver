package org.eclipse.aether.internal.named.impl;
...
import org.eclipse.aether.internal.named.NamedLockSupport;
import org.redisson.api.RSemaphore;

import java.util.concurrent.TimeUnit;

/**
 * Factory of {@link AdaptedSemaphoreNamedLock} instances using Redisson {@link RSemaphore}.
 */
    ...
    extends RedissonNamedLockFactorySupport
{
  ...
  {
    return new AdaptedSemaphoreNamedLock( name, this, new RedissonSemaphore( redissonClient.getSemaphore( name ) ) );
  }
