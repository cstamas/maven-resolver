...
import org.eclipse.aether.named.support.redisson.RedissonSemaphoreNamedLockFactory;
...
/**
 * Provider of {@link RedissonSemaphoreNamedLockFactory}.
 */
@Singleton
@Named( "semaphore-redisson" )
public class RedissonSemaphoreProvider
